...
exclude_ranges = [
    ...
    (0x400083dc, 0x400084a8), # Exclude after loop end,
...
# Save to JSON file
with open("configs/instruction_transient.json", "w") as f:
...
print(f"Saved to: output/instruction_transient.json")
