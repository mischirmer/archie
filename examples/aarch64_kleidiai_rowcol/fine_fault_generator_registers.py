...
sample_count = 111000 # for transient # 62000 # for permanent
...
# Save to JSON file
with open("configs/registers_transient.json", "w") as f:
...
print(f"Saved to: configs/registers_transient.json")
